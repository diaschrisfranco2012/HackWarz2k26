    ...
    <div ref={containerRef} className="relative bg-black text-white clip-path-auto">
      ...
      {isMobile && (
        <section className="relative min-h-[100svh] w-full bg-black flex flex-col items-center justify-center pt-12 pb-20 px-4 overflow-hidden z-20">
          ...
          >
            {/*LIVE RESULTS BUTTON FOR MOBILE */}
            <Link to="/results" className="w-full">
              <button className="w-full group relative px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 pointer-events-auto shadow-[0_0_40px_rgba(6,182,212,0.5)] hover:shadow-[0_0_60px_rgba(6,182,212,0.7)]">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <span className="relative flex items-center justify-center gap-2 font-black text-lg text-white tracking-widest uppercase">
                  Live Results
          ...
          <div className="sticky top-0 h-[100svh] w-full overflow-hidden flex flex-col items-center justify-center">
            ...
            >
              ...
              <div className="flex flex-row gap-4 w-auto px-0">
                {/* NEW LIVE RESULTS BUTTON FOR DESKTOP */}
                <Link to="/results" className="w-auto">
                  <button className="w-full group relative px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 pointer-events-auto shadow-[0_0_40px_rgba(6,182,212,0.5)] hover:shadow-[0_0_60px_rgba(6,182,212,0.7)]">
                    <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    <span className="relative flex items-center justify-center gap-2 font-black text-xl text-white tracking-widest uppercase">
                      Live Results
                ...
                <a href="/Hackwarz_brochure.pdf" download="Hackwarz_2026_brochure.pdf" className='w-auto'>
                <button className="w-full group relative px-10 py-4 border-2 border-purple-500/50 rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 hover:border-pink-500 pointer-events-auto bg-black/50 backdrop-blur-sm">
              ...
              >
                ...
                <div className="relative h-full bg-black/50 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 md:p-8 hover:border-pink-500/50 transition-all duration-300 text-center flex flex-col items-center">
                  ...
                  <div className="relative w-24 h-24 md:w-32 md:h-32 rounded-full mb-4 md:mb-6 p-1 bg-gradient-to-br from-purple-600 to-pink-600 group-hover:shadow-[0_0_20px_rgba(236,72,153,0.5)] transition-shadow duration-300">
                    ...
                    />
                <div className="absolute inset-1 bg-black rounded-full flex items-center justify-center text-3xl font-bold text-white" style={{ display: 'none' }}>                      {coordinator.name.split(' ').map(n => n[0]).join('')}
                    </div>
                  </div>
